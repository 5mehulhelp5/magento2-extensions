...
class ClientOx
{
    ...
    private function setCurl($b)
    {
        ...
        if (isset($b->settings['timeout'])) {
            curl_setopt($this->curl, CURLOPT_TIMEOUT, $b->settings['timeout']);
        }
