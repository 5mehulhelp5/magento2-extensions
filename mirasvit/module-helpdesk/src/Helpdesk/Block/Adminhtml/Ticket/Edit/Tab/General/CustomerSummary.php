...
class CustomerSummary extends Template
{
    ...
    public function getConfigJson()
    {
        ...
        if ($ticket->getCustomerId() || $ticket->getQuoteAddressId()) {
            ...
            $hasOrders = $this->helpdeskOrder->hasOrders($email, $ticket->getCustomerId(), $ticket->getStoreId());
            $params = [
            ...
            $hasOrders = $this->helpdeskOrder->hasOrders($ticket->getCustomerEmail(), $ticket->getStoreId());
            $params = [
                'customer_id' => '',
        ...
        $config = [
            ...
            '_autocompleteUrl' => $this->getUrl('helpdesk/ticket/customerfind', ['store_id' => $ticket->getStoreId()]),
