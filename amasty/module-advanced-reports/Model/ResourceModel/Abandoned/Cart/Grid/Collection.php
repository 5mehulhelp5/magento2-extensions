...
class Collection extends CartCollection implements SearchResultInterface
{
    ...
    public function getTotals(): array
    {
        ...
        $rowsSelect = clone $this->getSelect();

        $rowsSelect->reset('columns');
        $rowsSelect->columns(
            [
        ...
        $totalsSelect = $this->getConnection()->select()->from(
            ['rows' => $rowsSelect],
            [
        ...
        return array_merge($this->getConnection()->fetchRow($totalsSelect), ['products' => '', 'isTotal' => 1]);
    }
}
