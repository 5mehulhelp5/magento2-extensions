...
class PriceNotification implements NotificationTypeInterface
{
    /**
     * @var ConfigProvider
     */
    ...
    {
        return $this->configProvider->isPriceNotificationEnabled();
    }

    public function getTemplate(): string
    {
        return $this->configProvider->getPriceTemplate();
    }
}
