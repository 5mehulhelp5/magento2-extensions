...
class ImagesRepository implements \Amasty\AdvancedReview\Api\ImagesRepositoryInterface
{
    ...
    public function __construct(
        ...
        ?\Magento\Framework\Filesystem\Io\File $ioFile, // @deprecated
    ...
    public function delete(Data\ImagesInterface $image)
    {
        try {
            ...
            $mediaDirectory->delete($folderPath . $imagePath);
            $mediaDirectory->delete(
                $folderPath . 'resized/' . $this->configHelper->getReviewImageWidth() . $imagePath
            );
