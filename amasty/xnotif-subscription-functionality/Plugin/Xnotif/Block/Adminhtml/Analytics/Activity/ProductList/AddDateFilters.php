...
namespace Amasty\XnotifSubscriptionFunctionality\Plugin\Xnotif\Block\Adminhtml\Analytics\Activity\ProductList;

use Amasty\Xnotif\Block\Adminhtml\Analytics\Activity\ProductList;
...
class AddDateFilters
{
     ...
     */
    public function afterGetLastSubscribers(ProductList $subject, StockCollection $result): StockCollection
    {
