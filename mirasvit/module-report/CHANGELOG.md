...
#### Fixed
* Fixed the issue with the store filter in reports' toolbar
...
#### Fixed
* Fixed the conflict with Mirasvit Admin Bookmarks extension
...
#### Improvements
* Export filename based on the report name and export date
...
#### Improvements
* Ability to export unformatted numeric values in CSV
* Display whole column name in advanced mode
...
#### Fixed
* Fixed the issue with error messages not being displayed (some cases)
