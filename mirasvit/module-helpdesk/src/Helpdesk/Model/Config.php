...
class Config
{
    ...
    public function getGeneralAttachmentRemovalDays($store = null) : int
    {
        return (int) $this->scopeConfig->getValue(
            'helpdesk/general/attachment_removal_days',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }

    public function getGeneralIsAllowAttachmentRemoval($store = null) : string
    {
        return (string) $this->scopeConfig->getValue(
            'helpdesk/general/is_allow_attachment_removal',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
    ...
    {
        $cc = (string)$this->scopeConfig->getValue(
    ...
    {
        $statues = (string)$this->scopeConfig->getValue(
