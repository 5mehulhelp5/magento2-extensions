...
{
    public const STRICT_COUNT_FLAG = 'strict_count';
    ...
    public function __construct(
        ...
        \Forix\AmastyReviewCustom\Helper\Data $reviewHelper,
        $connection = null,
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFlag('filter_by_stars') || $this->getFlag('join_rating_summary')) {
            ...
            $ratingId = $this->reviewHelper->getDefaultRatingAverage($storeId);
            $this->getSelect()->join(
                ['votes' => $this->getTable('rating_option_vote')],
                sprintf('votes.review_id = main_table.review_id and votes.rating_id = %d', $ratingId),
