...
use Amasty\Reports\Model\Utilities\Brand\GetBrandAttributeCode;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Order\Item\Collection
{
    ...
    /**
     * @var GetBrandAttributeCode
     */
    private $getBrandAttributeCode;
    ...
    public function __construct(
        ...
        ?ConfigProvider $configProvider, // @deprecated
        GlobalRateResolver $globalRateResolver,
        AdapterInterface $connection = null,
        AbstractDb $resource = null,
        ?GetBrandAttributeCode $getBrandAttributeCode = null // TODO move to not optional
    ) {
        parent::__construct(
            $entityFactory,
            $logger,
        ...
        $this->getBrandAttributeCode = $getBrandAttributeCode
            ?? ObjectManager::getInstance()->get(GetBrandAttributeCode::class);
    }
    ...
    {
        $eav = $this->getBrandAttributeCode->execute();
