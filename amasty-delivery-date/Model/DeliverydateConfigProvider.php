        ...
        return [
            'amasty' => [
                'deliverydate' => [
                    ...
                    'dateShippingMethods' => is_string($this->helper->getStoreScopeValue('date_field/carriers'))
                        ? explode(',', $this->helper->getStoreScopeValue('date_field/carriers')) : [],
                    'timeEnabledCarriers' => (int)$this->helper->getStoreScopeValue('time_field/enabled_carriers'),
                    'timeShippingMethods' => is_string($this->helper->getStoreScopeValue('time_field/carriers'))
                        ? explode(',', $this->helper->getStoreScopeValue('time_field/carriers')) : [],
                    'commentEnabledCarriers' =>
                        (int)$this->helper->getStoreScopeValue('comment_field/enabled_carriers'),
                    'commentShippingMethods' => is_string($this->helper->getStoreScopeValue('comment_field/carriers'))
